# Quest Story: Per-category email opt-out (story-fixtures/06-critical-use-cases-missing.md)
...
Customers can disable marketing communications by category or entirely.
...
- **2026-09-12** · story · asserted_fact — "Don't need a walkthrough, it's just a settings toggle."
  *Effect*: Recorded, but flagged: no actor/goal/trigger/result captured.
...
**Score**: 59/100 (threshold: 70)
**Unmet critical conditions**: critical_use_cases_missing.
...
| Use Cases | ABSENT | 0/15 | fixture-assigned band for use_cases |
