# Quest Story: Per-category email opt-out (story-fixtures/07-scope-unbounded.md)
...
Whatever makes sense for a preferences system — we'll figure out the exact boundary as we build it.
...
- **2026-09-12** · story · asserted_fact — "Let's not lock down scope yet, we'll adjust as we go."
  *Effect*: Recorded, but flagged: no in/out/adjacent boundary given.
...
**Score**: 62/100 (threshold: 70)
**Unmet critical conditions**: scope_unbounded.
...
| Scope And Boundaries | ABSENT | 0/10 | fixture-assigned band for scope_and_boundaries |
