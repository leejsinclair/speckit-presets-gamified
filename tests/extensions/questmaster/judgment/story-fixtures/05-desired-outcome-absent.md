# Quest Story: Per-category email opt-out (story-fixtures/05-desired-outcome-absent.md)
...
Implement a NotificationPreference table and a settings page that writes to it.
...
The settings page saves successfully.
...
- **2026-09-12** · story · asserted_fact — "Just say it writes to the table, that's the outcome."
  *Effect*: Recorded, but flagged: this restates the solution, not a resulting state.
...
**Score**: 56/100 (threshold: 70)
**Unmet critical conditions**: desired_outcome_absent, success_not_evaluable.
...
| Desired Outcomes | ABSENT | 0/15 | fixture-assigned band for desired_outcomes |
...
| Solution Neutrality | WEAK | 2/5 | fixture-assigned band for solution_neutrality |
